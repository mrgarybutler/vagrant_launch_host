...
Copy-Item -Force $DOCUMENTS + '\vagrant_launch_host\connect_aws.rb' C:\Users\IEUser\.vagrant.d\gems\2.6.6\gems\vagrant-aws-0.7.2\lib\vagrant-aws\action\connect_aws.rb
